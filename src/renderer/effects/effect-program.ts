...
import { compileAdvancedDistortEffect } from "./programs/effect-program-advanced-distort";
import { compileBlurSharpenEffect } from "./programs/effect-program-blur-sharpen";
import { compileChannelKeyingEffect } from "./programs/effect-program-channel-keying";
import { compileChannelUtilityEffect } from "./programs/effect-program-channel-utility";
import { compileColorPipelineEffect } from "./programs/effect-program-color-pipeline";
import { compileDetailProcessingEffect } from "./programs/effect-program-detail-processing";
import { compileDrawGeneratorEffect } from "./programs/effect-program-draw-generators";
import { compileFramingEffect } from "./programs/effect-program-framing";
import { compileImmersiveVideoEffect } from "./programs/effect-program-immersive-video";
import { compileKeyingCleanupEffect } from "./programs/effect-program-keying-cleanup";
import { compileLayerStyleEffect } from "./programs/effect-program-layer-styles";
import { compileLightingEffect } from "./programs/effect-program-lighting";
import { compileMatteRefineEffect } from "./programs/effect-program-matte";
import { compileNoiseGrainEffect } from "./programs/effect-program-noise-grain";
import { compilePerspectiveEffect } from "./programs/effect-program-perspective";
import { compileProfessionalColorEffect } from "./programs/effect-program-professional-color";
import { compileQcOverlayEffect } from "./programs/effect-program-qc-overlays";
import { compileRetroMediaEffect } from "./programs/effect-program-retro-media";
import { compileSimulationEffect } from "./programs/effect-program-simulation";
import { compileAdvancedStylizeEffect } from "./programs/effect-program-stylize";
import { compileAdvancedTransitionEffect } from "./programs/effect-program-transitions";
...
function compileEffect(
  ...
  if (compileImmersiveVideoEffect(effect, time, emit)) return;
  ...
  if (compileQcOverlayEffect(effect, time, emit)) return;
  if (compileRetroMediaEffect(effect, time, emit)) return;
