...
- Data-driven catalog of 163 blur, color, channel, distort, generate, stylize, keying, time,
  transition, simulation, matte, perspective, layer-style, noise, and Looks effects, including 161 ordered GPU
  opcodes.
