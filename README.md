...
- Data-driven catalog of 195 blur, color, channel, distort, generate, stylize, keying, time,
  transition, simulation, matte, perspective, layer-style, noise, and Looks effects, including 193 ordered GPU
  opcodes.
