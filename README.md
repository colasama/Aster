...
- Data-driven catalog of 83 blur, color, distort, generate, stylize, keying, time, transition,
  simulation, matte, and Looks-style effects, including 72 fused GPU opcodes.
