...
- Data-driven catalog of 131 blur, color, channel, distort, generate, stylize, keying, time,
  transition, simulation, matte, perspective, and Looks-style effects, including 129 ordered GPU
  opcodes.
